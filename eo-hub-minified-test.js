    ...
    *==============================================================================*/
    ...
    function addMobilizeListeners(){
        ...
        //find Save for Qualifying Company industry sector fields in Hub panel
        let _btnQCIndustryName = jQuery('input[id$="_CompanyProfile_panelEditor_SaveButton"]');
        if (_btnQCIndustryName.length > 0){
            if (debugMode){
                console.log('Found Save CompanyProfile QC indsutry button from addMobilizeListeners()');
            }
            
            jQuery(_btnQCIndustryName).on('click', mojoMemberDetails ); 
        }
